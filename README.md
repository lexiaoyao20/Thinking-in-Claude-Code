...
> [第 1 章](#第-1-章架构全景) → [第 3 章](#第-3-章agent-循环) → [第 4 章](#第-4-章工具系统) → [第 5 章](#第-5-章权限模型) → [第 10 章](#第-10-章多-agent-协作) → [第 16 章](#第-16-章编程哲学)

### 专题路线
| 读者角色 | 推荐章节 |
|---------|---------|
| AI Agent 开发者 | 第 3、4、5、10、12 章 |
| CLI 工具开发者 | 第 2、6、7、8 章 |
| 系统架构师 | 第 1、8、9、13、16 章 |
| 安全工程师 | 第 5、9、14 章 |
...
#### 第 16 章：编程哲学
- [从 Claude Code 中可迁移的 12 个设计模式](./16-philosophy.md)
- 核心思想：**每个成熟系统都是设计模式的矿**
- 12 个模式：AsyncGenerator-as-Pipeline, Permission-as-Spectrum, File-as-IPC, ...
